...
public class Test extends JFrame implements ActionListener
{
	...
	private JPanel Order, pSize, Banner, banLeft, banMid, banRight, test, test2;
	...
	public Test() 
	{
		...
		test2 = new JPanel();
		test2.setLayout(new GridBagLayout());
		...
		addComp(Main,Banner,0,0,8,2,1,0);
		addComp(Main,test2,0,2,4,1,1,1);
		addComp(test2,pSize,0,1,3,1,0,0);
		addComp(test2,Order,3,1,1,2,0,0);
		addComp(test2,CrustType,0,2,1,1,0,0);
		addComp(test2,TopBox,1,2,2,1,0,0);
		//addComp(Main,next,0,4,3,1,2,2);
		//addComp(Main,txtArea,4,1,4,8,1,1);
		addComp(test2,lblQueue,0,3,3,1,0,0);
		addComp(test2,btnAdd,3,3,1,1,0,0);
		//addComp(Main,btnComp,3,4,1,1,0,0);
		//addComp(Main,btnQ,3,5,1,1,0,0);
		addComp(test2,btnStat,3,6,1,1,0,0);
		addComp(test2,test,0,4,4,2,0,0);
		
		addComp(test,next,0,0,3,1,1,1);
		addComp(test,btnComp,4,0,1,1,0,0);
		addComp(test,btnQ,4,1,1,1,0,0);
